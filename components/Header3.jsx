    ...
    <div className='bg-gradient-to-r from-red-600 to-red-400 h-60'>
      <div className=' p-5'>
        ...
        <div className='grid grid-cols-5 my-5 mx-20'>
            ...
            className=' h-16 outline-none px-3 text-lg border-r-2 border-gray-400 col-span-2'></input>
            <input type='text' placeholder='search...' 
            className=' h-16 outline-none px-3 text-lg border-r-2 border-gray-400 col-span-1'></input>
            <input type='text' placeholder='search...' 
            className=' h-16 outline-none px-3 text-lg border-r-2 border-gray-400 col-span-1'></input>
        ...
        <div className="flex mx-20 my-5 font-bold">
           ...
           <button type='submit' className='h-16 px-3 py-2 hover:cursor-pointer border-2 border-white text-white text-xl mr-5 hover:bg-gray-500 rounded-xl'>Homestay in India hotels</button>
        </div>
      </div>
    </div>
  )
